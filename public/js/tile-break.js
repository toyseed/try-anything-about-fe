...
(0, _jquery["default"])(window).ready(function () {
  ...
  function initEvents() {
    ...
    var mouseStart$ = (0, _rxjs.fromEvent)($block, "mousedown");
    var mouseEnd$ = (0, _rxjs.fromEvent)(document, "mouseup");
    var mouseMove$ = (0, _rxjs.fromEvent)(document, "mousemove");
    ...
    var touchMove$ = (0, _rxjs.fromEvent)(document, "touchmove").pipe((0, _operators.map)(function (event) {
    ...
    var game$ = start$.pipe((0, _operators.tap)(function (event) {
      ...
      setTimeout(function () {
        ...
        clearArea(areaComplete); // 게임 종료 조건 확인
  ...
  function clearRow(rows) {
    (0, _fromArray.fromArray)(rows).pipe((0, _operators.mergeMap)(function (row) {
      return (0, _rxjs.range)(0, boardCol).pipe((0, _operators.map)(function (i) {
        return row + i;
      }));
  ...
  function clearCol(cols) {
    (0, _fromArray.fromArray)(cols).pipe((0, _operators.mergeMap)(function (col) {
      return (0, _rxjs.range)(0, boardRow).pipe((0, _operators.map)(function (i) {
  ...
  function clearArea(areas) {
    (0, _fromArray.fromArray)(areas).pipe((0, _operators.mergeMap)(function (area) {
      return new _rxjs.Observable(function (observer) {
        var startIndex = area - boardCol - 1;

        for (var r = 0; r < blockRow; r++) {
          for (var c = 0; c < blockCol; c++) {
            var i = startIndex + (r * boardCol + c);
            observer.next(i);
          }
        }
      });
  ...
  function checkGameOver() {
    var result = true;
    var i = 0;
    var check$ = (0, _fromArray.fromArray)(board).pipe((0, _operators.map)(function (value) {
      return [i++, value];
    ...
    (0, _operators.mergeMap)(function (_ref2) {
      ...
      return value;
    }), (0, _operators.defaultIfEmpty)(false), (0, _operators.first)()).subscribe(function (hasSpace) {
      if (hasSpace) {
        result = false;
      }
    }, function (error) {
  ...
  function checkRowComplete(tiles) {
    ...
    try {
      for (var _iterator = tiles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var complete = true;
        var rowBase = row * boardCol;

        for (var i = 0; i < boardCol; i++) {
  ...
  function checkAreaComplete(tiles) {
    ...
    var findBase = function findBase(num) {
      return (0, _rxjs.of)(3, 6, 9).pipe((0, _operators.filter)(function (bound) {
        return bound - num > 0;
      }), (0, _operators.first)(), (0, _operators.map)(function (bound) {
        return bound - 2;
      }));
    };
    ...
    (0, _fromArray.fromArray)(tiles).pipe((0, _operators.map)(function (tile) {
      ...
      var col = Math.floor(index % boardCol);
      return [row, col];
    }), (0, _operators.switchMap)(function (_ref4) {
      var _ref5 = _slicedToArray(_ref4, 2),
          row = _ref5[0],
          col = _ref5[1];

      return (0, _rxjs.zip)(findBase(row), findBase(col));
    }), (0, _operators.map)(function (_ref6) {
      var _ref7 = _slicedToArray(_ref6, 2),
          baseRow = _ref7[0],
          baseCol = _ref7[1];

      return baseRow * boardCol + baseCol;
    }), (0, _operators.filter)(function (baseIndex) {
      return processed.indexOf(baseIndex) < 0;
    })).subscribe(function (baseIndex) {
      processed.push(baseIndex);
      var startIndex = baseIndex - boardCol - 1;
      var complete = true;

      for (var r = 0; r < blockRow; r++) {
        for (var c = 0; c < blockCol; c++) {
          var index = startIndex + (r * blockRow + c);
